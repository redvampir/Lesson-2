...
namespace Lesson2
{
    internal class Program
    {
        ...
        {
           CumputerClub cumputerClub = new CumputerClub (8);
            cumputerClub.Work();
        }
    ...
    class CumputerClub
    {
        ...
        public CumputerClub(int coumputersCount) 
        {
                ...
                if(int.TryParse(userInput, out int computerNumper))
                {
                    ...
                    if(computerNumper >= 0 && computerNumper < _computers.Count)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("Клиент пересчитал деньги, оплатил и сел за компьютер " + (computerNumper + 1));
                    ...
                    {
                        Console.WriteLine("Вы сами не знаете за какой компьютер посадить клиента. Он разозлися и ушёл.");
                    }
                }
                else
                {
